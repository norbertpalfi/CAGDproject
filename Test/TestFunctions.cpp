...
GLdouble surface_gabriels_horn::u_min = 0;
GLdouble surface_gabriels_horn::u_max = TWO_PI;
GLdouble surface_gabriels_horn::v_min = 0;
GLdouble surface_gabriels_horn::v_max = TWO_PI;
GLdouble surface_gabriels_horn::a = 0.1;

DCoordinate3 surface_gabriels_horn::d00(GLdouble u, GLdouble v)
{
    return DCoordinate3(u, a *cos(v)/u, a*sin(v)/u);
}
DCoordinate3 surface_gabriels_horn::d10(GLdouble u, GLdouble v)
{
    return DCoordinate3(1, -a*cos(v)/(u*u), -a*sin(v)/(u*u));
}
DCoordinate3 surface_gabriels_horn::d01(GLdouble u, GLdouble v)
{
    return DCoordinate3(u, -a*sin(v)/u, a*cos(v)/u);
}
...
GLdouble surface_helicoid::v_max = 3*TWO_PI;
GLdouble surface_helicoid::c = 0.5;

DCoordinate3 surface_helicoid::d00(GLdouble u, GLdouble v)
{
    return DCoordinate3(u * cos(v), u * sin(v), c * v);
}
...
{
    return DCoordinate3(u * -sin(v), u * cos(v), c);
}
