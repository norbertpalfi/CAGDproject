...
namespace cagd
{
    ...
    public:
        ...
        virtual GLboolean RenderDataCustomized(GLenum render_mode = GL_LINE_STRIP, int col=0,int row =0) const;
        virtual GLboolean RenderDataSides(GLenum render_mode = GL_POINTS,int side=0) const;
